---
name: symfony-mailer
description: Send email with symfony/mailer - Email and TemplatedEmail, transports and DSNs, async sending via Messenger, Mailpit in dev. Use whenever a Symfony project sends mail, even if the user mentions PHPMailer, SwiftMailer, or a vendor SMTP SDK.
---
...
- In dev, use `MAILER_DSN=null://null` to swallow mail, or point at
  ...
  the `symfony` skill's `references/ddev.md` for the DSN and how to open
  its UI.
