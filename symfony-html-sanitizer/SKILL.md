...
description: Sanitize user-submitted HTML with symfony/html-sanitizer - allowed elements and attributes, custom sanitizers. Use whenever a Symfony project stores or renders user-provided HTML (WYSIWYG output, comments, rich text), even if the user asks for HTMLPurifier or strip_tags.
---
