...
description: Validate input with symfony/validator - constraint attributes, custom constraints, groups, programmatic validation. Use whenever a Symfony task involves validating user input, DTOs, entities, or request payloads.
---
