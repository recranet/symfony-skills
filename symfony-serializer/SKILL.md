...
description: Serialize and deserialize with symfony/serializer - normalizers, groups, context, DTO mapping, JSON/XML/CSV. Use whenever a Symfony project converts objects to or from JSON or other formats, even if the user mentions JMS Serializer or manual json_decode mapping.
---
